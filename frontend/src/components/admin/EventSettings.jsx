...
export function EventSettings() {
    const { eventSettings, authFields, fetchSettings, updateSettings, updateAuthFields, uploadLogo } = useAdminStore();
    ...
    if (!eventSettings) return <div className="p-8 text-center">Carregando configurações...</div>;

    return (
        <div className="space-y-8 max-w-4xl mx-auto">
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-gray-800">Configuração do Evento</h2>
            </div>
                ...
                <div className="p-6">
                    <form onSubmit={handleSaveSettings} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Logo do Evento</label>
                                <div className="flex items-center gap-4">
                                    ...
                                    <label
                                        htmlFor="logo-upload"
                                        className="cursor-pointer bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2"
                                    >
                        ...
                        <div className="border-t border-gray-100 pt-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Modo de Autenticação</label>
                                    <select
                                        name="auth_mode"
                                ...
                                <div className="flex items-center gap-8 pt-6">
                                    <label className="flex items-center gap-3 cursor-pointer">
                                        ...
                                        />
                                        <span className="text-sm text-gray-700">Permitir Cadastro</span>
                                    </label>
                                    <label className="flex items-center gap-3 cursor-pointer">
                                        <input
                                            type="checkbox"
                                            ...
                                            className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                                        />
                                        <span className="text-sm text-gray-700">Habilitar 2FA (E-mail)</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border-t border-gray-100 pt-6">
                            ...
                            <label className="flex items-center gap-3 cursor-pointer">
                                <input
                                    ...
                                    className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                                />
                                <span className="text-sm text-gray-700">Habilitar Chat ao Vivo</span>
                            </label>
                        </div>

                        <div className="border-t border-gray-100 pt-6">
                            <h4 className="text-sm font-medium text-gray-500 mb-3">Configuração SMTP (Para E-mails)</h4>
                                ...
                                <div className="flex items-center">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <input
                                            ...
                                            className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                                        />
                                        <span className="text-xs text-gray-600">Seguro (SSL/TLS)</span>
                                    </label>
                                </div>
                                <div className="col-span-2">
                                    <input
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="font-semibold text-gray-800">Campos de Cadastro Personalizados</h3>
                    </div>
                    <button
                        onClick={addField}
                ...
                <div className="p-6">
                    <div className="space-y-4">
                        ...
                        {fieldsForm.map((field, index) => (
                            <div key={index} className="flex flex-col md:flex-row items-center gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div className="flex-1 w-full">
                                    <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 block">Rótulo</label>
                                    <input
                                        type="text"
                                        value={field.label}
                                ...
                                <div className="w-full md:w-1/4">
                                    <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 block">Placeholder (Dica)</label>
                                    <input
                                        type="text"
                                ...
                                <div className="w-full md:w-1/4">
                                    <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 block">Máscara (9=Num, a=Letra)</label>
                                    <input
                                        type="text"
                                        value={field.mask || ''}
