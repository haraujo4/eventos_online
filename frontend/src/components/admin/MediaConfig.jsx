    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-bold text-gray-800">Configuração de Mídia</h2>
                <div className="flex items-center gap-4">
                    <div className={`flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${mediaSettings.isLive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'}`}>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg mb-6 border border-gray-200">
                            ...
                            <form onSubmit={handleSubmitStream} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-xs font-medium text-gray-500 mb-1">Título da Stream</label>
                                    <input
                                        type="text"
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none h-20"
                                        value={streamDesc}
                                        ...
                                        <div className="space-y-2">
                                            {inputType === 'embed' ? (
                                                <textarea
                                                    ...
                                                    className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none h-24 font-mono"
                                                    value={streamUrl}
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-xs font-medium text-gray-500 mb-1">Poster Específico da Stream (Opcional)</label>
                            ...
                            {(mediaSettings.isLive || editingStreamId || previewStreamId) ? (
                                    ...
                                    {(editingStreamId && inputType === 'embed') || (!editingStreamId && mediaSettings.streams.find(s => s.id === previewStreamId)?.type === 'embed') ? (
                                        <div
                                            ...
                                            dangerouslySetInnerHTML={{
                                                __html: editingStreamId
                                                    ? streamUrl
                                                    : (mediaSettings.streams.find(s => s.id === previewStreamId)?.url || "")
                                            }}
                                        />
                                ...
                                <div className="absolute inset-0 flex items-center justify-center bg-gray-900">
                                    <p className="text-gray-500 text-sm">Selecione uma stream para visualizar</p>
                                </div>
                            )}
                        </div>

                        <div className="mt-4 space-y-2">
                            <p className="text-sm font-medium text-gray-700">Idiomas Disponíveis (Clique para Visualizar):</p>
